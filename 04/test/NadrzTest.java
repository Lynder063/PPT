...
public class NadrzTest {
    ...
    public void testSpecialniPripady() {
        ...
        try {
            ...
            nadrz.remove(50.0);
            assertEquals(0.0, nadrz.get_stav(), "Stav nádrže by měl být přesně 0.0");

            // Pokus o odebrání přesně 0 jednotek z prázdné nádrže
            assertTrue(nadrz.remove(0.0), "Odebrání 0 jednotek by mělo být vždy úspěšné");

            // Přidání přesně 0 jednotek do prázdné nádrže
            assertTrue(nadrz.add(0.0), "Přidání 0 jednotek by mělo být vždy úspěšné");
