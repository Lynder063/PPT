...
public class Nadrz {
     ...
     *
     * @param kolik Množství k přidání (musí být kladné)
    ...
    public boolean add(double kolik) throws PlnaNadrzException {
        ...
        if (stav_new > kapacita)
            throw new PlnaNadrzException("Nelze přidat " + kolik + ", kapacita by byla překročena");
     ...
     *
     * @param kolik Množství k odebrání (musí být kladné)
     * @return true pokud byla operace úspěšná
